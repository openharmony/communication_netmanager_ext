...
void WearableDistributedNetSupplierInfo::SetAvailable(sptr<NetSupplierInfo> &supplierInfo)
{
    supplierInfo->isAvailable_ = CONSTANTS::AVALIABLE;
}

void WearableDistributedNetSupplierInfo::SetRoamingStatus(sptr<NetSupplierInfo> &supplierInfo)
{
    supplierInfo->isRoaming_ = CONSTANTS::ROAMING_STATUS;
}

void WearableDistributedNetSupplierInfo::SetLinkUpBandwidthKbps(sptr<NetSupplierInfo> &supplierInfo)
{
    supplierInfo->linkUpBandwidthKbps_ = CONSTANTS::LINKUP_BAND_WIDTH_KBPS;
}

void WearableDistributedNetSupplierInfo::SetLinkDownBandwidthKbps(sptr<NetSupplierInfo> &supplierInfo)
{
