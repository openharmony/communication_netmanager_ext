                                             ...
                                             sptr<InterfaceConfiguration> cfg)
{
    ...
    if (pos == std::string::npos || fileContent.find(WRAP, pos) == std::string::npos) {
        return;
    }
...
void EthernetConfiguration::MakeConfig(sptr<InterfaceConfiguration> cfg, const std::string &fileContent)
{
