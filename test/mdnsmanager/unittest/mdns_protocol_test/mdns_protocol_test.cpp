 ...
 * @tc.desc: Test MDnsProtocolTest
 * @tc.type: FUNC
 */
HWTEST_F(MDnsProtocolTest, MDnsCommonTest001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MDnsProtocolTest, MDnsCommonTest002, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(MDnsProtocolTest, MDnsCommonTest003, TestSize.Level1)
{
