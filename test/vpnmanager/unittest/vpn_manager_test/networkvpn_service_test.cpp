...
HWTEST_F(NetworkVpnServiceTest, NetworkVpnServiceBranchTest001, TestSize.Level1)
{
    ...
    INetAddr iNetAddr;
    iNetAddr.type_ = 1;
    iNetAddr.family_ = 0x02;
    iNetAddr.prefixlen_ = 0;
    iNetAddr.address_ = "192.168.11.10";
    iNetAddr.netMask_ = "255.255.0.0";
    iNetAddr.hostName_ = "hostname1";
    iNetAddr.port_ = 10;
    vpnCfg->addresses_.push_back(iNetAddr);
    vpnCfg->addresses_.push_back(iNetAddr);
    Route route;
    route.iface_ = "eth0";
    route.rtnType_ = 2;
    ...
    route.destination_.type_ = 1;
    route.destination_.family_ = 1;
    ...
    route.gateway_.type_ = 1;
    route.gateway_.family_ = 1;
    ...
    vpnCfg->routes_.push_back(route);
    vpnCfg->routes_.push_back(route);
    vpnCfg->mtu_ = 1400;
    vpnCfg->dnsAddresses_.push_back("114.114.114.114");
    vpnCfg->dnsAddresses_.push_back("115.115.115.115");
    vpnCfg->searchDomains_.push_back("public1.114dns.com");
    vpnCfg->searchDomains_.push_back("public2.115dns.com");
    vpnCfg->acceptedApplications_.push_back("acceptedApplications1");
    vpnCfg->acceptedApplications_.push_back("acceptedApplications2");
    vpnCfg->refusedApplications_.push_back("refusedApplications1");
    vpnCfg->refusedApplications_.push_back("refusedApplications2");
