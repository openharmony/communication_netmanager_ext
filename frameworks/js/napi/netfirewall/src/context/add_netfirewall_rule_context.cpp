...
AddNetFirewallRuleContext::AddNetFirewallRuleContext(napi_env env, EventManager *manager) : BaseContext(env, manager) {}

void AddNetFirewallRuleContext::ParseParams(napi_value *params, size_t paramsCount)
{
    ...
    int32_t ret = NetFirewallParamCheck::CheckAddFirewallRule(GetEnv(), params[ARG_INDEX_0]);
