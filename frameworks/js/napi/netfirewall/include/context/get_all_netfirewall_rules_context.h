...
#ifndef NET_FIREWALL_GET_ALL_RULES_CONTEXT_H
#define NET_FIREWALL_GET_ALL_RULES_CONTEXT_H
...
public:
    ...
    // Issue parameter:Paging query results
    sptr<FirewallRulePage> pageInfo_;
};
} // namespace NetManagerStandard
} // namespace OHOS
#endif // NET_FIREWALL_GET_ALL_RULES_CONTEXT_H