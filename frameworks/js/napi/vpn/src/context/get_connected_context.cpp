...
GetConnectedContext::GetConnectedContext(napi_env env, EventManager *manager) : BaseContext(env, manager) {}

void GetConnectedContext::ParseParams(napi_value *params, size_t paramsCount)
{
    switch (paramsCount) {
        case PARAM_NONE:
            SetParseOK(true);
